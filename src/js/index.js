    ...
    const nav$ = xs.of(header([nav('#navigation .grey .darken-4', [
        div('.nav-wrapper', [
            ...
            ul('.left .hide-on-med-and-down', [
                ...
                makeLink('/settings', span(['Settings', ' ', settingsSVG]), '.white-text')
            ])
        ])
    ])]));
